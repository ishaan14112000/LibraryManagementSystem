<?php
session_start();
include '../student_side/connection.php';
...
<body class="login">
    ...
    <div class="login_wrapper">
        ...
        <section class="login_content">
            <form name="form1" action="" method="post">
                ...
                <div class="separator">
                    <p class="change_link">Student Login:
                        <a href="../student_side/login.php"> Click for Student Login </a>
                    </p>
    ...
    if(isset($_POST['submit1'])){
        ...
        <?php
            ...
            $_SESSION['admin_side']=$_POST['username'];
            ?>
